    ...
    <div className="w-full bg-white dark:bg-black" id="about">
      <div className="flex flex-col md:flex-row px-4">
        <div className="w-full ml-auto p-5">
          <img src="https://pngpix.com/images/hd/spider-man-city-background-png-05042024-wjlr1r7i5p9v03mu.jpg" alt="" className="a w-full" />
        </div>
        <br />

        <div className="flex flex-col justify-center">
          <h1 className="text-base lg:text-5xl text-blue-200 dark:text-blue-100">{t("content.amirrahemi")}</h1>
          <h2 className="text-base lg:text-2xl text-black dark:text-white">Software Engineer</h2>
